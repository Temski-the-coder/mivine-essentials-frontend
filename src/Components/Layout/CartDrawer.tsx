    ...
    >
      ...
      <div className="p-4 bg-white sticky bottom-0">
        <button
          ...
          className="w-full bg-gray-800 py-2 text-white rounded-lg font-semibold hover:bg-black hover:text-blue-100 items-center space-x-1 transition flex justify-center"
        >
